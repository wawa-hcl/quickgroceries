...
public class CustomerResponseDto {
    ...
    public CustomerResponseDto(String firstName, String lastName, int phoneNumber, String customerPreference, String email, String userName, AddressEntity customerAddress) {
